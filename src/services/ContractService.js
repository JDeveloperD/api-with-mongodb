 ...
 * @return Boolean
 */
function isRenewable(startDate, endOfPreviousContract) {
    // validamos si los datos recibidos son fechas
    ...
    return calculateDateDifferences(endOfPreviousContract, startDate, 'days') > 0
}
 ...
 * @return Boolean
 */
function theyAreValidDates(startDate, endDate) {
    ...
    let diffMonths = calculateDateDifferences(startDate, endDate, 'months');
 ...
 * @return Boolean
 */
function validWeeklyHours(hourlyValue) {
 ...
 * @return Boolean
 */
function validateHourValueByAcademicGrade(academicDegree, hourlyValue) {
 ...
 * @return Number
 */
function calculateDateDifferences(date1, date2, time) {
...
module.exports = {
    checkIfThereIsAValidContract,
    isRenewable,
    theyAreValidDates,
    validWeeklyHours,
    validateHourValueByAcademicGrade,
